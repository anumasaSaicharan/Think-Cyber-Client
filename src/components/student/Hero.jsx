  ...
  return (
    <div className="flex flex-col items-start justify-start w-full md:pt-10 pt-0 md:px-0 space-y-0 text-left bg-white">
      ...
      <div className="px-4 md:px-10 w-full">
        <h1
          className="relative font-bold uppercase max-w-3xl mx-auto md:mx-10 text-[32px] md:text-[46px] leading-tight md:leading-[54px] font-heebo text-[#24292D] text-center md:text-left mt-6 md:mt-0"
        >
